...
/** End point manager */
public class BiclasEndpointManager {
	...
	/** Port implementation */
	private BiclasPortImpl portImpl = new BiclasPortImpl(this);
	...
	public BiclasEndpointManager(String uddiURL, String wsName, String wsURL) {
	...
	public BiclasEndpointManager(String wsURL) {
		if (wsURL == null)
